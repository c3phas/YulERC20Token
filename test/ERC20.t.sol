...
contract ERC is Test{
    ...
    function testApprove() public{
        ...
        assertEq(erc20token.getAllowance(BOB),10,"Allowance not correct");
        vm.stopPrank();
    }
    ...
    function testTransferFrom() public {
        ...
        //console.log(erc20token.getAllowance(BOB));
        assertEq(erc20token.getAllowance(ALICE),25," First Allowance not correct");
        ...
        vm.prank(BOB);
        assertEq(erc20token.getAllowance(ALICE),5," Second Allowance not correct");
    }
